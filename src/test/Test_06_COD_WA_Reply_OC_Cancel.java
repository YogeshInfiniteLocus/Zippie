...
public class Test_06_COD_WA_Reply_OC_Cancel extends BaseTest {

	@Epic("WA Reply for COD-Order Confirmation On Cancel Order")
	@Feature("Verifying WA Reply for COD-Order Confirmation On Cancel Order")
	...
	public void verifyMsgReceivedTest() throws Exception {
		pomPages.POM_006_COD_WA_Reply_OC_Cancel verify = new pomPages.POM_006_COD_WA_Reply_OC_Cancel();
