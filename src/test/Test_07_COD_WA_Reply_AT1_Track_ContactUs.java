...
public class Test_07_COD_WA_Reply_AT1_Track_ContactUs extends BaseTest {

	@Epic("WA Reply for COD-Arriving Today 1 msg On Track and Contact us")
	@Feature("Verifying WA Reply for COD-Arriving Today 1 msg On Track and Contact us")
	...
	public void verifyMsgReceivedTest() throws Exception {
		pomPages.POM_007_COD_WA_Reply_AT1_Track_ContactUs verify = new pomPages.POM_007_COD_WA_Reply_AT1_Track_ContactUs();
