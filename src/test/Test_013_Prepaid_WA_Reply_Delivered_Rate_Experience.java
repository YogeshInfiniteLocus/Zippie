...
public class Test_013_Prepaid_WA_Reply_Delivered_Rate_Experience  extends BaseTest{

	@Epic("WA Reply for Prepaid-Delivered msg On Rate your Experience")
	@Feature("Verifying WA Reply for Prepaid-Delivered msg On Rate your Experience")
	...
	public void verifyMsgReceivedTest() throws Exception {
		pomPages.POM_002_HappyFlow_PrePaid verify = new pomPages.POM_002_HappyFlow_PrePaid();
		verify.verifyMsgReceived();
	}
	
	@Test(priority = 9, description = "Verify rate your experience")
	@Severity(SeverityLevel.CRITICAL)
	@Description("Test Description: Validating rate your experience")
	@Story("Story Name: To check rate your experience")
	public void verifyRateExperienceTest() throws Exception {
		pomPages.POM_013_Prepaid_WA_Reply_Delivered_Rate_Experience verify = new pomPages.POM_013_Prepaid_WA_Reply_Delivered_Rate_Experience();
		verify.verifyRateExperience();
	}
}
