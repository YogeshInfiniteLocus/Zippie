...
public class Test_09_COD_WA_Reply_RA_Cancel_Order extends BaseTest  {

	@Epic("WA Reply for COD-Re-Attempt msg On Cancel Order")
	@Feature("Verifying WA Reply for COD-Re-Attempt msg On Cancel Order")
	...
	public void verifyMsgReceivedTest() throws Exception {
		pomPages.POM_009_COD_WA_Reply_RA_Cancel_Order verify = new pomPages.POM_009_COD_WA_Reply_RA_Cancel_Order();
