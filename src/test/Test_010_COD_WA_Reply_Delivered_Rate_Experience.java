...
public class Test_010_COD_WA_Reply_Delivered_Rate_Experience extends BaseTest {

	@Epic("WA Reply for COD-Delivered msg On Rate your Experience")
	@Feature("WA Reply for COD-Delivered msg On Rate your Experience")
	...
	public void verifyRateExperienceTest() throws Exception {
		pomPages.POM_010_COD_WA_Reply_Delivered_Rate_Experience verify = new pomPages.POM_010_COD_WA_Reply_Delivered_Rate_Experience();
