...
public class Test_Happy_Flow_02_COD_Cancel_Flow extends BaseTest{
	
	@Epic("Happy Flow COD-Cancelled")
	@Feature("Verifying Happy Flow COD-Cancelled")
	...
	public void verifyMsgReceivedTest() throws Exception {
		pomPages.POM_003_HappyFlow_COD_Cancel_Flow verify = new pomPages.POM_003_HappyFlow_COD_Cancel_Flow();
