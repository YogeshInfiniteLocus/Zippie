...
public class Test_Happy_Flow_04_Prepaid_Cancel_Flow extends BaseTest {
	
	@Epic("Happy Flow Prepaid-Cancelled")
	@Feature("Verifying Happy Flow Prepaid-Cancelled")
	...
	public void verifyMsgReceivedTest() throws Exception {
		pomPages.POM_004_HappyFlow_PrePaid_Cancel_Flow verify = new pomPages.POM_004_HappyFlow_PrePaid_Cancel_Flow();
