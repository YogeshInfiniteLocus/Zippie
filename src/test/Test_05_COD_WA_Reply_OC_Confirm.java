...
public class Test_05_COD_WA_Reply_OC_Confirm extends BaseTest {

	@Epic("WA Reply for COD-Order Confirmation On Confirm Order")
	@Feature("Verifying WA Reply for COD-Order Confirmation On Confirm Order")
	...
	public void verifyMsgReceivedTest() throws Exception {
		pomPages.POM_005_COD_WA_Reply_OC_Confirm verify = new pomPages.POM_005_COD_WA_Reply_OC_Confirm();
