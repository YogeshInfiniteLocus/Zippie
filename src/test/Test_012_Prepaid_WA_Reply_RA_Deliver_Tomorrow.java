...
public class Test_012_Prepaid_WA_Reply_RA_Deliver_Tomorrow extends BaseTest {

	@Epic("WA Reply for Prepaid-Re-Attempt msg On Deliver tomorrow")
	@Feature("Verifying WA Reply for Prepaid-Re-Attempt msg On Deliver tomorrow")
	...
	public void verifyMsgReceivedTest() throws Exception {
		pomPages.POM_012_Prepaid_WA_Reply_RA_Deliver_Tomorrow verify = new pomPages.POM_012_Prepaid_WA_Reply_RA_Deliver_Tomorrow();
