...
public class Test_08_COD_WA_Reply_RA_Deliver_Tomorrow extends BaseTest {

	@Epic("WA Reply for COD-Re-Attempt msg On Deliver tomorrow")
	@Feature("Verifying WA Reply for COD-Re-Attempt msg On Deliver tomorrow")
	...
	public void verifyMsgReceivedTest() throws Exception {
		pomPages.POM_008_COD_WA_Reply_RA_Deliver_Tomorrow verify = new pomPages.POM_008_COD_WA_Reply_RA_Deliver_Tomorrow();
